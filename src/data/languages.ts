export const Translations = {
  en: {
    ...
    Seats: 'Seats',
    'Seat map': 'Seat map',
    'Seats fill in arrival order, starting from 1': 'Seats fill in arrival order, starting from 1',
  ...
  ko: {
    ...
    Seats: '자리',
    'Seat map': '자리 배치',
    'Seats fill in arrival order, starting from 1': '먼저 들어온 순서대로 1번부터 앉습니다',
