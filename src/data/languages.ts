export const Translations = {
  en: {
    ...
    'Seat map': 'Seat map',
    'name@3 pins seat 3. Click a seat number to rename it': 'name@3 pins seat 3. Click a seat number to rename it',
  ...
  ko: {
    ...
    'Seat map': '자리 배치',
    'name@3 pins seat 3. Click a seat number to rename it': '이름@3 = 3번 고정 · 자리 번호를 누르면 이름표를 바꿀 수 있습니다',
    'Reset labels': '번호 초기화',
